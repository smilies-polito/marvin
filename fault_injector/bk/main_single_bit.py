...
fault_location = "registers" #possible value memory, registers, pc
...
def parse_args():
	...
	parser.add_argument('--number-faults', '-n', type=int, default=100, help='Number of faults to inject during the injection campaign.')
	...
	parser.add_argument('--benchmark', '-b', type=str, default='sha', help='Select the benchmark, possible choises are dijkstra, quicksort and sha.', choices=['dijkstra', 'quicksort', 'sha'])
...
def main(args):
	...
	print("Num of fault: " + str(num_of_fault))
