...
HD_PWD='/home/kike/Desktop/marvin/vivado_project/pynqZ2_platform/pynqZ2_platform.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log free_rtos_v1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source free_rtos_v1_wrapper.tcl -notrace
