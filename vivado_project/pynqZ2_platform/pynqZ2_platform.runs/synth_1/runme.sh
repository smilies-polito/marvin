...
HD_PWD='/home/kike/Desktop/marvin/vivado_project/pynqZ2_platform/pynqZ2_platform.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log free_rtos_v1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source free_rtos_v1_wrapper.tcl
