...
--Date        : Tue Jul  9 14:53:31 2024
--Host        : travelmate running 64-bit Ubuntu 22.04.4 LTS
--Command     : generate_target free_rtos_v1.bd
--Design      : free_rtos_v1
...
entity free_rtos_v1 is
  ...
  attribute CORE_GENERATION_INFO of free_rtos_v1 : entity is "free_rtos_v1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=free_rtos_v1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of free_rtos_v1 : entity is "free_rtos_v1.hwdef";
end free_rtos_v1;

architecture STRUCTURE of free_rtos_v1 is
  component free_rtos_v1_processing_system7_0_0 is
  port (
  ...
  end component free_rtos_v1_processing_system7_0_0;
...
begin
processing_system7_0: component free_rtos_v1_processing_system7_0_0
     port map (
