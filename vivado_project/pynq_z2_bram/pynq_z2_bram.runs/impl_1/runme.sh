...
HD_PWD='/home/kike/Desktop/marvin/vivado_project/pynq_z2_bram/pynq_z2_bram.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_z2_bram_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pynq_z2_bram_wrapper.tcl -notrace
